...
def relation_search_prune(entity_id, entity_name, pre_relations, pre_head, question, args):
    # print("--relation search prune called--")
    ...
    # print("TOTAL RELATIONS from KG len = ",len(total_relations))
    if args.prune_tools == "llm":
        ...
        # print("\nlen of retrieve_relations_with_scores = ",len(retrieve_relations_with_scores))
...
def entity_score(question, entity_candidates_id, score, relation, args):
    # print("entity_candidates_id inside entity score: ", entity_candidates_id)
    entity_candidates = [id2entity_name_or_type(entity_id) for entity_id in entity_candidates_id]
    # print("Entity candidates found after id2entity name: ",entity_candidates )
...
def half_stop(question, cluster_chain_of_entities, depth, args):
    # print("--Half stop called--")
    # print("No new knowledge added during search depth %d, stop searching." % depth)
    # print("Generating answer using cluster_chain_of_entities: ", cluster_chain_of_entities)
    answer = generate_answer(question, cluster_chain_of_entities, args)
    save_2_jsonl(question, answer, cluster_chain_of_entities, file_name=args.dataset, ans_from="LLM+KG-half_stop")


def generate_answer(question, cluster_chain_of_entities, args): 
    # print("-- !! Generating answer with KG !! --")
...
def entity_prune(total_entities_id, total_relations, total_candidates, total_topic_entities, total_head, total_scores, args):
    # print("--inside entity prune--")
    # print("total_entities_id, total_relations, total_candidates, total_topic_entities, total_head, total_scores")
    # print(total_entities_id, total_relations, total_candidates, total_topic_entities, total_head, total_scores)
    ...
    # print("output of entities prune: flag, chain_of_entities, entities_id, pre_relations, pre_heads")
    # print(True, cluster_chain_of_entities, entities_id, relations, heads)
